...
data_key = {'CAVE': 'im', 'Harvard': 'ref', 'ICVL': 'data', 'ICVL_2020_h5': 'data'}
data_size = {'CAVE': (512, 512, 31), 'Harvard': (1040, 1392, 31), 'ICVL': (1392, 1300, 31), 'ICVL_2020_h5': (1392, 1300, 31)}
seed_key = {'CAVE': 1, 'Harvard': 2, 'ICVL': 3, 'ICVL_2020_h5': 3}
...
train_test_idx = {'CAVE': np.array([1] * 20 + [2] * 12),
                  ...
                  'ICVL_2020_h5': np.random.choice((1, 2), data_list.shape[0], p=(.8, .2))}
